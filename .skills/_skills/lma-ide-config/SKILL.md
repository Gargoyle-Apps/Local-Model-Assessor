...
For apps without generator support (Zed, Goose, Pi, OpenCode), follow the manual instructions in `integrations/IDE-model-management/IDE.md`. MLX LM models are not generated by `sweep-ide-config.py` — see `lma-mlx-lm`.
