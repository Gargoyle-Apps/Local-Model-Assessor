...
| lma-hf-mcp | Use the Hugging Face MCP server for Hub discovery during LMA assess/import when the client is connected | huggingface mcp, hf mcp, hf-mcp-server, search huggingface, hub search, find gguf, mlx-community search, hugging face search |
